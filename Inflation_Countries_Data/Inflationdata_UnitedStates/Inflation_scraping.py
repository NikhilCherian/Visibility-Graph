...
favg=open('F:\git\Inflation_Countries_Data\Inflationdata_UnitedStates\Averageinflation_UnitedStates.csv','wb')
fannu=open('F:\git\Inflation_Countries_Data\Inflationdata_UnitedStates\Annualinflation_UnitedStates.csv','wb')



fl=open("F:\git\Inflation_Countries_Data\Inflationdata_UnitedStates\htmldoc_Inflation_UnitedStates.html",'r')
...
for row in tablestats.findAll('tr',{'class': 'tabledata1'}):
    ...
    if re.search("Average CPI inflation",x):
        ...
        y1=re.sub('\CPI United States', '', year1)
        ...
        y2=re.sub('\CPI United States', '', year2)
