...
favg=open('F:\git\Inflation_Countries_Data\Inflationdata_Israel\Averageinflation_Israel.csv','wb')
fannu=open('F:\git\Inflation_Countries_Data\Inflationdata_Israel\Annualinflation_Israel.csv','wb')



fl=open("F:\git\Inflation_Countries_Data\Inflationdata_Israel\htmldoc_Inflation_Israel.html",'r')
