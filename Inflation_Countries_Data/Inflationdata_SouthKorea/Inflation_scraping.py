...
favg=open('F:\git\Inflation_Countries_Data\Inflationdata_SouthKorea\Averageinflation_SouthKorea.csv','wb')
fannu=open('F:\git\Inflation_Countries_Data\Inflationdata_SouthKorea\Annualinflation_SouthKorea.csv','wb')



fl=open("F:\git\Inflation_Countries_Data\Inflationdata_SouthKorea\htmldoc_Inflation_SouthKorea.html",'r')
...
for row in tablestats.findAll('tr',{'class': 'tabledata1'}):
    ...
    if re.search("Average CPI inflation",x):
        ...
        y1=re.sub('\CPI South Korea', '', year1)
        ...
        y2=re.sub('\CPI South Korea', '', year2)
